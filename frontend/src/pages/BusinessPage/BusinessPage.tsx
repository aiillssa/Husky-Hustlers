...
export const checkImageExistence = async (
  ...
  for (const str of blobNames) {
    ...
    if (DEBUG)
      console.log("return: ", id === userID.toString() && source === imgSource);
  ...
  useEffect(() => {
    ...
    const fetchBanner = async () => {
      ...
      if (await checkImageExistence(id, "banner")) {
        ...
        setBannerURL(
          "https://hustlers.blob.core.windows.net/images/defaultbanner.jpg"
        );
      }
    };
    ...
    <div className={classes.root}>
      ...
      <div className={classes.infoFrame}>
        {!hasBusiness ? (
          ...
          <div className={classes.noBusinessContainer}>
            <div className={classes.noBusinessBox}>
              <h2 className={classes.noBusinessTitle}>No Business Found</h2>
              <p className={classes.noBusinessMessage}>{message}</p>
              <Link
                to="/pages/AddBusinessPage"
